#!/usr/bin/env node
/**
 * Generate 10-minute drive-time isochrones for all 252 Basque Country municipios.
 *
 * Usage:
 *   ORS_API_KEY=your_key node scripts/generate-isochrones.js
 *
 * Uses OpenRouteService free tier (40 req/min, 2000/day).
 * Resumes from progress.json if interrupted.
 *
 * Outputs:
 *   data/es/isochrones/municipios/{ine_code}.geojson
 *   data/es/isochrones/provincias/{code}.geojson
 */
...
const PROGRESS_PATH = path.join(ROOT, 'data', 'es', 'isochrones', 'progress.json');
