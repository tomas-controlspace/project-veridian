...
export function passesFilters(m: MunicipioMetrics, filters: Filters): boolean {
  ...
  if (filters.catch_pop_min != null && (m.catchment_pop == null || m.catchment_pop < filters.catch_pop_min)) return false;
  if (filters.catch_pop_max != null && (m.catchment_pop == null || m.catchment_pop > filters.catch_pop_max)) return false;
